...
var json = {"items": [
       ...
       {
   "exerciseName": "Intro<br><br><br><br>",
   "exerciseGif":  "https://treadibbu.imfast.io/Introduction.mp4",
    "muted" : "1",
    "reps" : ""
 },
 {
  "exerciseName": "Warm Up<br>Jumping Jacks<br><br><br>Swipe Right Once Done",
  "exerciseGif":  "https://treadibbu.imfast.io/WarmUp_JJ.mp4",
   "muted" : "1",
   "reps" : ""
},
{
...
},
{
...

 {
  ...
  "time":"60",
   ...
   "exerciseGif": "https://treadibbu.imfast.io/Cool%20Down.mp4",
...
function theEnd(){
    ...
    console.log(newCards[0].childNodes);
     ...
     console.log(newCards[0].childNodes,newCards[0]);
    newCards[0].childNodes[3].src = "workouts//completed.jpeg";
    console.log(newCards[0].childNodes[5].href);
    newCards[0].childNodes[5].href = "https://docs.google.com/forms/d/e/1FAIpQLSflOpXBD8N-qOYUw_EtY_dIo_ohGzcLWP_oUhWBFDlVQ1tBqw/viewform";
    newCards[0].childNodes[5].childNodes[0].innerHTML = "Feedback Form";
